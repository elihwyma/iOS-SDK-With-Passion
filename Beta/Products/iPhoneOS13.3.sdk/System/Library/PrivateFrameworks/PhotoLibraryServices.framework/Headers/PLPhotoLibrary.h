...
- (struct NSObject { Class x1; }*)imageForFormat:(unsigned short)arg1 forAsset:(id)arg2;
...
- (id)name;
- (struct NSObject { Class x1; }*)newImageForPhoto:(id)arg1 format:(unsigned short)arg2;
- (struct NSObject { Class x1; }*)newImageForPhoto:(id)arg1 format:(unsigned short)arg2 allowPlaceholder:(bool)arg3 outImageProperties:(const struct __CFDictionary {}**)arg4 outDeliveredPlaceholder:(bool*)arg5;
