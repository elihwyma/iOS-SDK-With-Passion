...
- (id).cxx_construct;
- (void).cxx_destruct;
- (id)dataForPacket:(const struct Packet { struct atomic<re::Packet *> { _Atomic struct Packet {} *x_1_1_1; } x1; void *x2; void *x3; unsigned int x4; unsigned int x5; int x6; void *x7; struct Packet {} *x8; }*)arg1 channel:(unsigned char)arg2;
- (void)dealloc;
