...
+ (id)grantWithNamespace:(struct NSString { Class x1; }*)arg1 endowment:(struct NSObject { Class x1; }*)arg2 attributes:(id)arg3;
+ (id)grantWithNamespace:(struct NSString { Class x1; }*)arg1 sourceEnvironment:(id)arg2 attributes:(id)arg3;
+ (id)grantWithNamespace:(struct NSString { Class x1; }*)arg1 sourceEnvironment:(id)arg2 endowment:(struct NSObject { Class x1; }*)arg3 attributes:(id)arg4;

- (void).cxx_destruct;
- (id)_initWithNamespace:(struct NSString { Class x1; }*)arg1 sourceEnvironment:(id)arg2 endowment:(struct NSObject { Class x1; }*)arg3 attributes:(id)arg4;
- (id)attributes;
