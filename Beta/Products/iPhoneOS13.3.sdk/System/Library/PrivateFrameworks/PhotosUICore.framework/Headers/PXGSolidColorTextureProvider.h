...
- (void)_requestTextureForColor:(struct UIColor { Class x1; }*)arg1 targetSize:(struct CGSize { double x1; double x2; })arg2 traitCollection:(id)arg3 requestID:(int)arg4;
