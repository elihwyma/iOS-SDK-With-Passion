...
@property (nonatomic, retain) WiFiAnalyticsAWDWiFiMetricsManagerFrameCounterStats *frameCounters;
...
@property (nonatomic, retain) WiFiAnalyticsAWDWPA2Counters *mcastWPA2Counters;
@property (nonatomic, retain) WiFiAnalyticsAWDChipCountersRx *rxGeneralStats;
@property (nonatomic, retain) WiFiAnalyticsAWDMacCountersRx *rxMACCounterStats;
@property (nonatomic, retain) WiFiAnalyticsAWDMacCountersRxErrors *rxMACErrorStats;
@property (nonatomic, retain) WiFiAnalyticsAWDRxPhyErrors *rxPhyErrors;
@property (nonatomic) unsigned long long timestamp;
@property (nonatomic, retain) WiFiAnalyticsAWDChipErrorCountersTx *txErrorStats;
@property (nonatomic, retain) WiFiAnalyticsAWDChipCountersTx *txGeneralStats;
@property (nonatomic, retain) WiFiAnalyticsAWDWPA2Counters *ucastWPA2Counters;
