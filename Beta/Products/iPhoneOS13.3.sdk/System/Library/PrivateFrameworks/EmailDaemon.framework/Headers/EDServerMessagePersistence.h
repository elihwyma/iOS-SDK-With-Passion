...
- (id)serverMessagesInIMAPUIDRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 limit:(unsigned long long)arg2 returnLastEntries:(bool)arg3;
- (bool)supportsLabels;
