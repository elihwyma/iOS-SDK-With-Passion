...
- (void)addImageViewsAfterSortIfNecessaryForTrackedInfos:(id)arg1 existingInfos:(id)arg2 textView:(struct ICBaseTextView { Class x1; }*)arg3 textContainerOrigin:(struct CGPoint { double x1; double x2; })arg4 todoUUIDsToImageViews:(id)arg5;
- (void)addImageViewsBeforeSortIfNecessaryForTrackedInfos:(id)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2 textContainerOrigin:(struct CGPoint { double x1; double x2; })arg3 todoUUIDsToImageViews:(id)arg4;
...
- (id)adjacentTrackedParagraphFromTrackedParagraph:(id)arg1 inDirection:(unsigned long long)arg2 inTextView:(struct UITextView { Class x1; }*)arg3;
- (bool)alwaysHighlightAuthorEdits;
- (id)analyticsInfoForChecklistAtIndex:(unsigned long long)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2;
...
- (void)applySortFromOriginalParagraphs:(id)arg1 sortedTrackedParagraphs:(id)arg2 forTextView:(struct ICTextView { Class x1; }*)arg3 checklistRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg4;
...
- (void)autoSortChecklistForUnitTestAtIndex:(unsigned long long)arg1 textView:(struct ICTextView { Class x1; }*)arg2;
- (void)autoSortChecklistIfNecessaryForTrackedParagraph:(id)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2 analyticsHandler:(id /* block */)arg3;
...
- (bool)canIndentTextView:(struct UITextView { Class x1; }*)arg1 byDelta:(long long)arg2 forRanges:(id)arg3;
- (bool)canMoveCheckedChecklistsToBottomInTextView:(struct UITextView { Class x1; }*)arg1 forRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (bool)canMoveListItemInDirection:(unsigned long long)arg1 inTextView:(struct UITextView { Class x1; }*)arg2 forRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (bool)checklistItemExistsMarkedCompleted:(bool)arg1 inTextView:(struct UITextView { Class x1; }*)arg2 forRanges:(id)arg3;
...
- (id)createTreeFromTrackedParagraphs:(id)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2;
- (void)dealloc;
...
- (id)expandedChecklistTrackedParagraphsInTextView:(struct UITextView { Class x1; }*)arg1 forIndex:(long long)arg2;
- (struct _NSRange { unsigned long long x1; unsigned long long x2; })expandedRangeForContiguousTodosForRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 textView:(struct UITextView { Class x1; }*)arg2;
...
- (id)imageInfoForTrackedParagraph:(id)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2 characterRangeToRender:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3 visibleRectToRender:(struct CGRect { struct CGPoint { double x_1_1_1; double x_1_1_2; } x1; struct CGSize { double x_2_1_1; double x_2_1_2; } x2; })arg4;
...
- (void)indentRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg1 byAmount:(long long)arg2 inTextStorage:(id)arg3 textView:(struct UITextView { Class x1; }*)arg4 forceUpdateAttributes:(bool)arg5;
- (id)init;
...
- (void)markAllChecklistItemsCompleted:(bool)arg1 inTextview:(struct UITextView { Class x1; }*)arg2 forSelectedRanges:(id)arg3;
- (bool)moveCheckedChecklistsToBottomInTextView:(struct UITextView { Class x1; }*)arg1 forRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2;
- (bool)moveCheckedChecklistsToBottomInTextView:(struct ICTextView { Class x1; }*)arg1 forRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 animated:(bool)arg3;
- (bool)moveListItemInDirection:(unsigned long long)arg1 inTextView:(struct UITextView { Class x1; }*)arg2 forRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg3;
- (id)note;
...
- (void)performAnimatedSortForTrackedParagraphs:(id)arg1 expandedRange:(struct _NSRange { unsigned long long x1; unsigned long long x2; })arg2 textView:(struct ICTextView { Class x1; }*)arg3 sortChecklistsBlock:(id /* block */)arg4;
...
- (void)removeChecklistItemsMarkedCompleted:(bool)arg1 inTextView:(struct UITextView { Class x1; }*)arg2 forRanges:(id)arg3;
...
- (void)sendTextDidChangeNotificationForTextView:(struct UITextView { Class x1; }*)arg1;
...
- (void)setFinalFramesForSortedInfos:(id)arg1 textView:(struct ICBaseTextView { Class x1; }*)arg2 textContainerOrigin:(struct CGPoint { double x1; double x2; })arg3 todoUUIDsToImageViews:(id)arg4;
...
- (void)setSelectionToIndex:(unsigned long long)arg1 onTextView:(struct UITextView { Class x1; }*)arg2;
...
- (void)showFirstTimeAutoSortEnabledAlertIfNecessaryWithTextView:(struct ICBaseTextView { Class x1; }*)arg1 completionHandler:(id /* block */)arg2 analyticsHandler:(id /* block */)arg3;
- (void)showFirstTimeAutoSortEnabledAlertWithTextView:(struct ICBaseTextView { Class x1; }*)arg1 completionHandler:(id /* block */)arg2 analyticsHandler:(id /* block */)arg3;
...
- (id)validAdjacentParagraphInfoFromParagraphInfo:(id)arg1 inDirection:(unsigned long long)arg2 inTextView:(struct UITextView { Class x1; }*)arg3;
