...
@interface ICAttachmentImageLoadingOperation : NSOperation {
    ...
    struct NSCache { Class x1; id x2; void *x3[5]; void *x4; } * _cache;
    NSString * _cacheKey;
...
- (struct NSCache { Class x1; id x2; void *x3[5]; void *x4; }*)cache;
- (id)cacheKey;
- (id)completionHandlers;
- (bool)forceFullSizeImage;
- (id)initWithCache:(struct NSCache { Class x1; id x2; void *x3[5]; void *x4; }*)arg1 attachment:(id)arg2 attachmentType:(short)arg3 forceFullSizeImage:(bool)arg4 completionHandler:(id /* block */)arg5;
- (void)main;
- (id)mediaURL;
...
- (void)setCache:(struct NSCache { Class x1; id x2; void *x3[5]; void *x4; }*)arg1;
