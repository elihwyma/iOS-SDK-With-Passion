...
@property (nonatomic, retain) NSMutableDictionary *accountIDCanBeUpdated;
@property (nonatomic, retain) NSMutableDictionary *accountIDDeviceCheckDate;
...
- (void).cxx_destruct;
- (id)accountIDCanBeUpdated;
- (id)accountIDDeviceCheckDate;
...
- (void)convertDrawingsInNote:(id)arg1 inWindow:(struct UIWindow { Class x1; }*)arg2 message:(id)arg3 completion:(id /* block */)arg4;
...
- (void)setAccountIDCanBeUpdated:(id)arg1;
- (void)setAccountIDDeviceCheckDate:(id)arg1;
