...
- (void)dealloc;
- (id)displayString;
- (void)encodeToArchive:(struct DateCellValueArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; struct FormatStructArchive {} *x5; double x6; bool x7; bool x8; }*)arg1;
- (id)format;
- (unsigned long long)hash;
- (id)initWithArchive:(const struct DateCellValueArchive { int (**x1)(); struct InternalMetadataWithArena { void *x_2_1_1; } x2; struct HasBits<1> { unsigned int x_3_1_1[1]; } x3; struct CachedSize { struct atomic<int> { _Atomic int x_1_2_1; } x_4_1_1; } x4; struct FormatStructArchive {} *x5; double x6; bool x7; bool x8; }*)arg1 locale:(id)arg2;
