...
- (struct NSDictionary { Class x1; }*)valuesForKeyPaths:(id)arg1;
...
- (struct NSDictionary { Class x1; }*)valuesForKeyPaths:(id)arg1 synchronous:(bool)arg2 responseQueue:(id)arg3 withCompletion:(id /* block */)arg4;
- (id)xpcConnection;
- (id)xpcEventQueue;
- (id)xpcQueue;
