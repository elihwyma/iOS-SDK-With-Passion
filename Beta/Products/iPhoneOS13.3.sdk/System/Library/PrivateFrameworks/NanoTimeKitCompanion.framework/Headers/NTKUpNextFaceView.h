...
@interface NTKUpNextFaceView : NTKDigitalFaceView <CLKMonochromeFilterProvider, NTKSensitiveUIStateObserver, REElementActionDelegate, REUIElementIntentActionDelegate, REUIRelevanceEngineControllerDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate> {
...
- (void)_loadCollectionViewDataAnimated:(bool)arg1 completion:(id /* block */)arg2;
