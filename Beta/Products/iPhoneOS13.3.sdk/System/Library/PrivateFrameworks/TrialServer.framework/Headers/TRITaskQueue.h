...
- (struct NSNumber { Class x1; }*)_addTask:(id)arg1 withDependencies:(id)arg2;
- (bool)_queueScheduledTasks:(id)arg1 nextTaskStartTime:(id*)arg2;
- (bool)addTask:(id)arg1;
- (bool)cancelTask:(struct NSNumber { Class x1; }*)arg1;
- (bool)cancelTasksWithTag:(id)arg1;
- (id)client;
- (bool)containsTaskId:(struct NSNumber { Class x1; }*)arg1;
- (unsigned long long)count;
- (id)createOperationWithTask:(id)arg1 withId:(struct NSNumber { Class x1; }*)arg2 dependencies:(id)arg3 taskMap:(id)arg4;
- (void)dealloc;
- (void)finishedTask:(id)arg1 withId:(struct NSNumber { Class x1; }*)arg2 status:(int)arg3;
...
- (bool)removeTaskWithId:(struct NSNumber { Class x1; }*)arg1;
