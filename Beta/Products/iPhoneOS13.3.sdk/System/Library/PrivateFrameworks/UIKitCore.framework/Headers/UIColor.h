...
@property (nonatomic, readonly) NSString *hbcp_propertyListValue;
...
// Image: /Library/Frameworks/Alderis.framework/Alderis

- (id)hbcp_propertyListValue;
- (id)initWithHbcp_propertyListValue:(id)arg1;
...
// Image: /usr/lib/TweakInject/SystemTintCustomColor.dylib
