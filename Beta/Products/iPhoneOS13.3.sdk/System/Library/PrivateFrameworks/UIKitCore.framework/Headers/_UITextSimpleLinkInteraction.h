...
- (bool)_beginInteractionSessionForLinkAtPoint:(struct CGPoint { double x1; double x2; })arg1 asTap:(bool)arg2;
- (bool)_canBeginInteractionSessionForLinkAtPoint:(struct CGPoint { double x1; double x2; })arg1 asTap:(bool)arg2;
