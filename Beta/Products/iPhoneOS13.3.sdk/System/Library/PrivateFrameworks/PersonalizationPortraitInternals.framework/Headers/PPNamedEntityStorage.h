...
- (void)_prepareDonationStatement:(id)arg1 scoredNamedEntity:(struct PPScoredItem { Class x1; }*)arg2 algorithm:(unsigned long long)arg3 cloudSync:(bool)arg4 decayRate:(double)arg5 sentimentScore:(double)arg6 occurrencesInSource:(unsigned short)arg7 weightMultiplier:(double)arg8 sourceRowId:(long long)arg9;
