...
- (void)accountsDataForMigrator:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 9: <WLDataclassMigrating> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, unsigned long long, NSError *, void*
...
- (void)summariesDataForAccount:(void *)arg1 migrator:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 10: WLSourceDeviceAccount *, <WLDataclassMigrating> *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, unsigned long long, NSError *, void*
