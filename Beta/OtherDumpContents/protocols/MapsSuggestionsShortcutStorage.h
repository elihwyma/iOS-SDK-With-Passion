...
- (bool)addOrUpdateShortcuts:(void *)arg1 handler:(void *)arg2; // needs 2 arg types, found 7: struct NSArray { Class x1; }*, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
- (bool)loadAllShortcutsWithHandler:(void *)arg1; // needs 1 arg types, found 7: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, struct NSArray { Class x1; }*, NSError *, void*
...
- (bool)removeShortcuts:(void *)arg1 handler:(void *)arg2; // needs 2 arg types, found 7: struct NSArray { Class x1; }*, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
