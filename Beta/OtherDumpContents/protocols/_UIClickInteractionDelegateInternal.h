...
- (void)_clickInteraction:(void *)arg1 shouldBegin:(void *)arg2; // needs 2 arg types, found 7: _UIClickInteraction *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, bool, void*
