...
- (bool)forwardGeocodePostalAddress:(void *)arg1 completion:(void *)arg2; // needs 2 arg types, found 8: id, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, struct NSArray { Class x1; }*, NSError *, void*
...
- (bool)searchPOIWithName:(void *)arg1 ofPOICategory:(void *)arg2 withinVenue:(void *)arg3 maxResults:(void *)arg4 completion:(void *)arg5; // needs 5 arg types, found 11: NSString *, NSString *, <GEOVenueIdentifier> *, unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, struct NSArray { Class x1; }*, NSError *, void*
- (bool)searchString:(void *)arg1 maxResults:(void *)arg2 completion:(void *)arg3; // needs 3 arg types, found 9: NSString *, unsigned int, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, struct NSArray { Class x1; }*, NSError *, void*
