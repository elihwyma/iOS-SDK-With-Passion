...
- (id /* block */)connectionBlock:(void *)arg1; // needs 1 arg types, found 8: id /* block */, PBItemCollection *, NSArray *, unsigned long long, bool, void*, id, SEL
...
- (void)setConnectionBlock:(void *)arg1; // needs 1 arg types, found 9: id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, PBItemCollection *, NSArray *, unsigned long long, bool, void*
