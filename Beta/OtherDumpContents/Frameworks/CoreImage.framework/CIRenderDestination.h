...
- (id)_initWithInternalRenderDestination:(struct RenderDestination { int (**x1)(); struct atomic<unsigned int> { _Atomic unsigned int x_2_1_1; } x2; struct __CFString {} *x3; struct CGColorSpace {} *x4; }*)arg1 width:(unsigned long long)arg2 height:(unsigned long long)arg3 format:(int)arg4 colorspace:(struct CGColorSpace { }*)arg5;
- (struct RenderDestination { int (**x1)(); struct atomic<unsigned int> { _Atomic unsigned int x_2_1_1; } x2; struct __CFString {} *x3; struct CGColorSpace {} *x4; }*)_internalRenderDestination;
