...
@interface NEIKEv2IKESA : NSObject {
    ...
    struct NSMutableData { Class x1; } * _digitalSignatureLocalPrivateKey;
    struct NSMutableData { Class x1; } * _digitalSignatureLocalPublicKey;
    struct NSMutableData { Class x1; } * _digitalSignatureRemotePublicKey;
    NEIKEv2EAP * _eapClient;
    bool  _eapInProgress;
    struct NSMutableData { Class x1; } * _encryptCryptoCtx;
    NSError * _error;
    struct NSMutableData { Class x1; } * _fetchedPassword;
    struct NSMutableData { Class x1; } * _fetchedSharedSecret;
    ...
    struct NSMutableData { Class x1; } * _localCertificateIdentity;
    ...
    struct NSMutableData { Class x1; } * _sKeySeed;
    ...
    struct NSMutableData { Class x1; } * _skAi;
    struct NSMutableData { Class x1; } * _skAr;
    struct NSMutableData { Class x1; } * _skD;
    struct NSMutableData { Class x1; } * _skEi;
    struct NSMutableData { Class x1; } * _skEr;
    struct NSMutableData { Class x1; } * _skPi;
    struct NSMutableData { Class x1; } * _skPr;
...
+ (bool)checkValidityOfDigitalSignature:(id)arg1 authenticationProtocol:(id)arg2 sessionConfiguration:(id)arg3 remoteSignedOctets:(struct NSMutableData { Class x1; }*)arg4;
+ (bool)checkValidityOfDigitalSignature:(id)arg1 sessionConfiguration:(id)arg2 remoteSignedOctets:(struct NSMutableData { Class x1; }*)arg3;
+ (struct NSMutableData { Class x1; }*)copySharedSecretFromConfig:(id)arg1;
+ (struct NSMutableData { Class x1; }*)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2 prfProtocol:(id)arg3;
...
- (struct NSMutableData { Class x1; }*)createAuthenticationDataForSharedSecret:(id)arg1 octets:(id)arg2;
- (id)createInitiatorAuthenticationData;
- (id)createInitiatorEAPAuthenticationData;
- (struct NSMutableData { Class x1; }*)createInitiatorSignedOctets;
- (id)createLocalSPIForLocalAddress:(id)arg1 remoteAddress:(id)arg2;
- (struct NSMutableData { Class x1; }*)createRemoteSignedOctets;
- (id)createResponderAuthenticationData;
- (id)createResponderEAPAuthenticationData;
- (struct NSMutableData { Class x1; }*)createResponderSignedOctets;
- (void)dealloc;
- (id)decryptionKey;
- (id)description;
...
- (struct NSMutableData { Class x1; }*)digitalSignatureLocalPrivateKey;
- (struct NSMutableData { Class x1; }*)digitalSignatureLocalPublicKey;
- (struct NSMutableData { Class x1; }*)digitalSignatureRemotePublicKey;
- (void)disableWildcard;
- (unsigned long long)dpdRetryIntervalMilliseconds;
- (id)eapClient;
- (bool)eapInProgress;
- (struct NSMutableData { Class x1; }*)encryptCryptoCtx;
- (id)encryptionKey;
- (id)error;
- (bool)fetchLocalCertificateIdentity;
- (struct NSMutableData { Class x1; }*)fetchedPassword;
- (struct NSMutableData { Class x1; }*)fetchedSharedSecret;
...
- (id)localAddress;
- (struct NSMutableData { Class x1; }*)localCertificateIdentity;
...
- (id)packetDelegate;
- (struct NSMutableData { Class x1; }*)password;
...
- (void)resyncAddress;
- (struct NSMutableData { Class x1; }*)sKeySeed;
...
- (void)setDigitalSignatureLocalPrivateKey:(struct NSMutableData { Class x1; }*)arg1;
- (void)setDigitalSignatureLocalPublicKey:(struct NSMutableData { Class x1; }*)arg1;
- (void)setDigitalSignatureRemotePublicKey:(struct NSMutableData { Class x1; }*)arg1;
- (void)setEapClient:(id)arg1;
- (void)setEapInProgress:(bool)arg1;
- (void)setEncryptCryptoCtx:(struct NSMutableData { Class x1; }*)arg1;
- (void)setError:(id)arg1;
- (void)setFetchedPassword:(struct NSMutableData { Class x1; }*)arg1;
- (void)setFetchedSharedSecret:(struct NSMutableData { Class x1; }*)arg1;
...
- (void)setLocalCertificateIdentity:(struct NSMutableData { Class x1; }*)arg1;
...
- (void)setSKeySeed:(struct NSMutableData { Class x1; }*)arg1;
...
- (void)setSkAi:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkAr:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkD:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkEi:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkEr:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkPi:(struct NSMutableData { Class x1; }*)arg1;
- (void)setSkPr:(struct NSMutableData { Class x1; }*)arg1;
...
- (struct NSMutableData { Class x1; }*)sharedSecret;
- (unsigned short)shortDPDCounter;
- (bool)shouldReceiveWildcard;
- (bool)shouldReportShortDPD;
- (bool)shouldSendStateUpdate;
- (id)signHashData;
- (struct NSMutableData { Class x1; }*)skAi;
- (struct NSMutableData { Class x1; }*)skAr;
- (struct NSMutableData { Class x1; }*)skD;
- (struct NSMutableData { Class x1; }*)skEi;
- (struct NSMutableData { Class x1; }*)skEr;
- (struct NSMutableData { Class x1; }*)skPi;
- (struct NSMutableData { Class x1; }*)skPr;
