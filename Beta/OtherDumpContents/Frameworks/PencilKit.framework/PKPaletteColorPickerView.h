...
@interface PKPaletteColorPickerView : UIView <PKColorPickerDelegate, PKEdgeLocatable, PKPalettePopoverDismissing, PKPaletteQuickColorPicking, PKPaletteViewSizeScaling, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate> {
