...
@interface PKPaletteAdditionalOptionsView : UIView <PKEdgeLocatable, PKPaletteMoreOptionsViewControllerDelegate, PKPalettePopoverDismissing, PKPaletteViewSizeScaling, UIPopoverPresentationControllerDelegate> {
    bool  _autoHideOn;
