...
+ (struct UIImage { Class x1; }*)imageForSubAttachment:(id)arg1;
+ (struct UIImage { Class x1; }*)imageForSubAttachment:(id)arg1 allowCached:(bool)arg2;
+ (struct UIImage { Class x1; }*)imageForSubAttachment:(id)arg1 rotateForMacImageGallery:(bool)arg2 allowCached:(bool)arg3;
