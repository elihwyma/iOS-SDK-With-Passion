...
@interface ICAttachmentBrickViewV2 : UIView <ICAttachmentBrickAudioPlayerViewV2Delegate> {
    ...
    struct UIView { Class x1; } * _accessoryView;
    ...
    struct UIView { Class x1; } * _backgroundView;
...
- (struct UIView { Class x1; }*)accessoryView;
...
- (struct UIColor { Class x1; }*)backgroundColorForCurrentVibrancy;
- (struct UIView { Class x1; }*)backgroundView;
...
- (void)setAccessoryView:(struct UIView { Class x1; }*)arg1;
...
- (void)setBackgroundView:(struct UIView { Class x1; }*)arg1;
