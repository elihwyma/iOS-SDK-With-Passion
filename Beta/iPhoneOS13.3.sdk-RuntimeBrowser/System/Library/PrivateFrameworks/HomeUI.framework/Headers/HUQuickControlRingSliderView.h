...
@property (nonatomic, retain) UIView *overlappingSupplementaryValueMarkingView;
...
- (double)outerRadius;
- (id)overlappingSupplementaryValueMarkingView;
...
- (void)setOverlappingSupplementaryValueMarkingView:(id)arg1;
