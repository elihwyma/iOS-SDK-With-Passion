...
- (struct NSArray { Class x1; }*)imageInferenceForward:(id)arg1 input:(struct NSArray { Class x1; }*)arg2 lossLabels:(id)arg3;
- (struct NSArray { Class x1; }*)imageTrainingForward:(id)arg1 input:(struct NSArray { Class x1; }*)arg2 lossLabels:(id)arg3;
