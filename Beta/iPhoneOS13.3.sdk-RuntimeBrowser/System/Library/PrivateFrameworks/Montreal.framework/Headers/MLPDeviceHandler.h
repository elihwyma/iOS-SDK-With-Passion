...
- (id)deduceDevice;
- (id)device;
- (struct NSArray { Class x1; }*)imageBatchFromMatrix:(id)arg1 m2iKernel:(id)arg2 cmdBuf:(id)arg3 width:(unsigned long long)arg4 height:(unsigned long long)arg5 channels:(unsigned long long)arg6;
...
- (id)matrixFromImages:(struct NSArray { Class x1; }*)arg1 i2mKernel:(id)arg2 cmdBuf:(id)arg3;
...
- (id)tempMatrixFromImages:(struct NSArray { Class x1; }*)arg1 i2mKernel:(id)arg2 cmdBuf:(id)arg3;
