...
+ (struct UIImage { Class x1; }*)imageForSearchUserCategory:(unsigned long long)arg1 useSearchFieldStyle:(bool)arg2;
...
+ (void)suggestionsDisplayDataFromToken:(id)arg1 searchText:(id)arg2 matchedColor:(struct UIColor { Class x1; }*)arg3 remainingColor:(struct UIColor { Class x1; }*)arg4 isTextCompletion:(bool)arg5 completion:(id /* block */)arg6;
