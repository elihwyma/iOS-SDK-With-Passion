...
@property (nonatomic, retain) PXPeopleQuestionsGadgetProvider *questionsGadgetProvider;
@property (nonatomic, retain) PXHorizontalCollectionGadgetProvider *questionsHorizontalGadgetProvider;
...
- (id)priorityManager;
- (id)questionsGadgetProvider;
- (id)questionsHorizontalGadgetProvider;
...
- (void)setQuestionsGadgetProvider:(id)arg1;
- (void)setQuestionsHorizontalGadgetProvider:(id)arg1;
