...
@interface PXCuratedLibraryAllPhotosLayout : PXGSplitLayout <PXAssetsDataSourceManagerObserver, PXChangeObserver, PXCuratedLibraryBodyLayout, PXCuratedLibraryInlineHeadersLayoutGeometrySource, PXCuratedLibraryViewModelPresenter, PXGDisplayAssetSource, PXGItemsLayoutDelegate> {
    ...
    struct PXGItemsLayout { Class x1; } * _decadesItemLayout;
    struct PXGItemsLayout { Class x1; } * _didAnimateTowardsAnchorInItemsLayout;
...
- (void).cxx_destruct;
- (void)_configureLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (struct PXGItemsLayout { Class x1; }*)_createLayoutWithNumberOfColumns:(long long)arg1;
- (id)_displayAssetForItem:(long long)arg1;
- (long long)_estimatedItemsPerScreenForLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (double)_interItemSpacingForLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (double)_itemCaptionSpacingForLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (bool)_layoutHasIndividualItems:(struct PXGItemsLayout { Class x1; }*)arg1;
- (bool)_layoutIsAspectFit:(struct PXGItemsLayout { Class x1; }*)arg1;
- (bool)_layoutWantsSingleDateTitle;
- (void)_performAnchorAlignmentVisualShiftWithBaseLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (void)_performVisualShiftWithLayout:(struct PXGItemsLayout { Class x1; }*)arg1 movingItem:(long long)arg2 toColumn:(long long)arg3;
...
- (struct CGSize { double x1; double x2; })_scaleForLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
...
- (struct PXGItemsLayout { Class x1; }*)didAnimateTowardsAnchorInItemsLayout;
- (id)displayAssetFetchResultForSpritesInRange:(struct _PXGSpriteIndexRange { unsigned int x1; unsigned int x2; })arg1 inLayout:(struct PXGItemsLayout { Class x1; }*)arg2;
...
- (struct PXGItemsLayout { Class x1; }*)primaryItemsLayout;
...
- (unsigned long long)supportedDisplayAssetPresentationStylesInLayout:(struct PXGItemsLayout { Class x1; }*)arg1;
- (void)update;
- (id)viewModel;
