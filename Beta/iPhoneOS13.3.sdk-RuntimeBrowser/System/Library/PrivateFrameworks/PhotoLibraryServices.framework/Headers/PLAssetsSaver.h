...
- (void).cxx_destruct;
- (id)_addCameraAssetToLibraryWithPath:(id)arg1 thumbnailImage:(struct NSObject { Class x1; }*)arg2 assetUUID:(id)arg3 metadata:(id)arg4 assetType:(short)arg5 kind:(short)arg6 kindSubtype:(short)arg7 avalancheUUID:(id)arg8 completionHandler:(id /* block */)arg9;
- (id /* block */)_createWriteImageCompletionBlockWithImage:(struct NSObject { Class x1; }*)arg1 target:(id)arg2 selector:(SEL)arg3 contextInfo:(void*)arg4;
...
- (void)_saveImage:(struct NSObject { Class x1; }*)arg1 imageData:(id)arg2 properties:(id)arg3 completionBlock:(id /* block */)arg4;
...
- (void)saveCameraVideoAtPath:(id)arg1 withMetadata:(id)arg2 thumbnailImage:(struct NSObject { Class x1; }*)arg3 createPreviewWellImage:(bool)arg4 progressStack:(id)arg5 isSlalom:(bool)arg6 assetAdjustments:(id)arg7 videoHandler:(id /* block */)arg8 requestEnqueuedBlock:(id /* block */)arg9 completionBlock:(id /* block */)arg10;
- (void)saveImage:(struct NSObject { Class x1; }*)arg1 imageData:(id)arg2 properties:(id)arg3 completionTarget:(id)arg4 completionSelector:(SEL)arg5 contextInfo:(void*)arg6;
- (void)saveImage:(struct NSObject { Class x1; }*)arg1 properties:(id)arg2 completionBlock:(id /* block */)arg3;
...
- (void)savePhotoStreamImage:(struct NSObject { Class x1; }*)arg1 imageData:(id)arg2 properties:(id)arg3 completionBlock:(id /* block */)arg4;
