...
+ (struct NSObject { Class x1; }*)generatePosterFrameForAVAsset:(id)arg1 maxSize:(struct CGSize { double x1; double x2; })arg2 error:(id*)arg3;
+ (struct NSObject { Class x1; }*)generatePosterFrameForVideoAtURL:(id)arg1 maxSize:(struct CGSize { double x1; double x2; })arg2 error:(id*)arg3;
