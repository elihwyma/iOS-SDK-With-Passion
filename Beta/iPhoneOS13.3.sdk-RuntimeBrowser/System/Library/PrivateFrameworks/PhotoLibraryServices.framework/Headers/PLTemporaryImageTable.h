...
- (void)dealloc;
- (struct NSObject { Class x1; }*)imageForItemAtIndex:(unsigned long long)arg1;
- (id)initWithWithPath:(id)arg1 imageFormat:(unsigned short)arg2;
- (void)insertItemAtIndex:(unsigned long long)arg1;
- (void)removeItemAtIndex:(unsigned long long)arg1;
- (void)reset;
- (void)setImage:(struct NSObject { Class x1; }*)arg1 forItemAtIndex:(unsigned long long)arg2;
