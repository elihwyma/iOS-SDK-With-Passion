...
- (id)_arrangeSolutionItems:(id)arg1 alongLayoutAxis:(int)arg2 forContainer:(id)arg3 additionalLayoutOffset:(struct CGPoint { double x1; double x2; })arg4 interItemSpacing:(id)arg5;
...
- (id)_frameForAbsoluteIndex:(long long)arg1 additionalFrameOffset:(struct CGPoint { double x1; double x2; })arg2 interSolutionSpacing:(double)arg3 repeatAxis:(int)arg4;
- (struct CGPoint { double x1; double x2; })_frameOffsetForAdditionalFrameOffset:(struct CGPoint { double x1; double x2; })arg1 repeatOffset:(long long)arg2 repeatAxis:(int)arg3 interSolutionSpacing:(double)arg4;
...
- (struct CGPoint { double x1; double x2; })_outerContainerOffsetForGroup:(id)arg1 groupComputedSize:(struct CGSize { double x1; double x2; })arg2 container:(id)arg3 outerLayoutAxis:(int)arg4;
...
- (id)_supplementaryFrameWithKind:(id)arg1 absoluteIndex:(long long)arg2 additionalFrameOffset:(struct CGPoint { double x1; double x2; })arg3 interSolutionSpacing:(double)arg4 repeatAxis:(int)arg5;
...
- (struct CGSize { double x1; double x2; })contentSizeForFrameCount:(long long)arg1 layoutAxis:(int)arg2;
- (id)copyWithZone:(struct _NSZone { }*)arg1;
- (id)description;
- (long long)frameCount;
- (id)frameForAbsoluteIndex:(long long)arg1 additionalFrameOffset:(struct CGPoint { double x1; double x2; })arg2 interSolutionSpacing:(double)arg3 repeatAxis:(int)arg4;
...
- (id)supplementaryFrameWithKind:(id)arg1 absoluteIndex:(long long)arg2 additionalFrameOffset:(struct CGPoint { double x1; double x2; })arg3 interSolutionSpacing:(double)arg4 repeatAxis:(int)arg5;
