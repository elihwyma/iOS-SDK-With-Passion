...
@interface _UIClickPresentationInteraction : NSObject <UIGestureRecognizerDelegate, UIInteraction, UIInteraction_Private, _UIClickInteractionDelegateInternal, _UIDragInteractionPresentationDelegate> {
