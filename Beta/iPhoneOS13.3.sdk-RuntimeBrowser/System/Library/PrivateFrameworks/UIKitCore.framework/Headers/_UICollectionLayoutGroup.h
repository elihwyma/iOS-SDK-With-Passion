...
- (id)initWithlayoutSize:(id)arg1 contentInsets:(struct NSDirectionalEdgeInsets { double x1; double x2; double x3; double x4; })arg2 layoutAxis:(int)arg3 isCustomGroup:(bool)arg4 subitems:(id)arg5 count:(long long)arg6 supplementaryItems:(id)arg7 interItemSpacing:(id)arg8 groupOptions:(long long)arg9 subitemsProvider:(id /* block */)arg10 frameProvider:(id /* block */)arg11 customGroupItemProvider:(id /* block */)arg12 visualFormats:(id)arg13 visualFormatProvider:(id /* block */)arg14;
- (id)interItemSpacing;
- (bool)isCustomGroup;
