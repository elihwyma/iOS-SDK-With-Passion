...
+ (void)showAlertsIfNecessaryForDeletingSharedNotes:(id)arg1 noteDeleteType:(unsigned long long)arg2 displayWindow:(struct UIWindow { Class x1; }*)arg3 completionHandler:(id /* block */)arg4;
