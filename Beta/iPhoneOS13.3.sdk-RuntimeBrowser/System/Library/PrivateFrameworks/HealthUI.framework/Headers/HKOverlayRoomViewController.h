...
- (bool)_shouldUpdateContextItemsForChanges:(struct NSDictionary { Class x1; }*)arg1;
...
- (void)sampleTypeDateRangeController:(id)arg1 didUpdateDateRanges:(struct NSDictionary { Class x1; }*)arg2;
