...
@interface CNFAccessAuthorization : NSObject {
    ...
    struct NSNumber { Class x1; } * _isClientLegacyImpl;
    struct NSNumber { Class x1; } * _isNotesAccessGrantedCachedValue;
    <CNTCC> * _tcc;
}
...
- (void).cxx_destruct;
- (struct NSNumber { Class x1; }*)_checkIfNotesAccessGranted;
...
- (struct NSNumber { Class x1; }*)resolveFuture:(id)arg1;
...
- (void)setIsClientLegacyImpl:(struct NSNumber { Class x1; }*)arg1;
- (void)setIsNotesAccessGrantedCachedValue:(struct NSNumber { Class x1; }*)arg1;
- (void)setTcc:(id)arg1;
