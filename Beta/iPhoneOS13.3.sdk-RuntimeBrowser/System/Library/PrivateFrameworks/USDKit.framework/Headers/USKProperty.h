...
- (id)typeName;
- (id)urlValue;
- (struct UsdProperty { int x1; struct Usd_PrimDataHandle { struct intrusive_ptr<const pxrInternal_v0_19__pxrReserved__usdkit__::Usd_PrimData> { struct Usd_PrimData {} *x_1_2_1; } x_2_1_1; } x2; struct SdfPath { struct intrusive_ptr<const pxrInternal_v0_19__pxrReserved__usdkit__::Sdf_PathNode> { struct Sdf_PathNode {} *x_1_2_1; } x_3_1_1; } x3; struct TfToken { struct TfPointerAndBits<const pxrInternal_v0_19__pxrReserved__usdkit__::TfToken::_Rep> { struct _Rep {} *x_1_2_1; } x_4_1_1; } x4; })usdProperty;
