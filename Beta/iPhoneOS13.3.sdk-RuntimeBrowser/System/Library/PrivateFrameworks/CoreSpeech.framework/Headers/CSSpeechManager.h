...
@interface CSSpeechManager : NSObject <CSActivationEventNotifierDelegate, CSAudioProviderDelegate, CSAudioRecorderDelegate, CSAudioServerCrashMonitorDelegate, CSVoiceTriggerAssetHandlerDelegate, CSVoiceTriggerXPCServiceDelegate> {
