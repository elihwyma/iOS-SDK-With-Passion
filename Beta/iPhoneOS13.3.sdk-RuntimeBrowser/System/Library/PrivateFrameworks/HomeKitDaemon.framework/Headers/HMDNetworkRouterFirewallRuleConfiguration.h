...
+ (bool)__decodeFullAccessFromNetworkDeclarations:(struct NSDictionary { Class x1; }*)arg1 key:(id)arg2 fullAccess:(bool*)arg3;
+ (bool)__decodeNetworkDeclarationsFromJSONDictionary:(struct NSDictionary { Class x1; }*)arg1 networkDeclarations:(struct NSDictionary {}**)arg2;
+ (id)__decodeRulesFromNetworkDeclarations:(struct NSDictionary { Class x1; }*)arg1 key:(id)arg2 class:(Class)arg3 required:(bool)arg4;
+ (id)logCategory;
...
- (id)initWithAccessoryIdentifier:(id)arg1 jsonDictionary:(struct NSDictionary { Class x1; }*)arg2;
