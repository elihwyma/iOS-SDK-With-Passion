...
+ (bool)__decodeFlags:(struct NSDictionary { Class x1; }*)arg1 critical:(bool*)arg2;
+ (bool)__decodeHostnames:(id)arg1 subject:(id*)arg2;
+ (bool)__decodePorts:(struct NSDictionary { Class x1; }*)arg1 portStart:(unsigned short*)arg2 portEnd:(unsigned short*)arg3;
+ (bool)__decodePurpose:(struct NSDictionary { Class x1; }*)arg1 purpose:(unsigned long long*)arg2;
+ (bool)__decodeSubject:(struct NSDictionary { Class x1; }*)arg1 subject:(id*)arg2;
+ (bool)__decodeType:(struct NSDictionary { Class x1; }*)arg1 transportProtocol:(unsigned char*)arg2 error:(id*)arg3;
...
- (id)icmpTypes;
- (id)initWithJSONDictionary:(struct NSDictionary { Class x1; }*)arg1 name:(id)arg2 critical:(bool)arg3 purpose:(unsigned long long)arg4 transportProtocol:(unsigned char)arg5 subject:(id)arg6 portStart:(unsigned short)arg7 portEnd:(unsigned short)arg8 icmpTypes:(id)arg9;
