...
- (void).cxx_destruct;
- (bool)__addOverrides:(struct NSDictionary { Class x1; }*)arg1 replace:(bool)arg2 options:(id)arg3 activity:(id)arg4 error:(id*)arg5;
...
- (struct NSDictionary { Class x1; }*)__fetchNetworkDeclarationDataForRecordIDs:(id)arg1 options:(id)arg2 activity:(id)arg3 error:(id*)arg4;
- (struct NSDictionary { Class x1; }*)__fetchNetworkDeclarationDataForZoneID:(id)arg1 options:(id)arg2 activity:(id)arg3 error:(id*)arg4;
- (struct NSDictionary { Class x1; }*)__fetchNetworkDeclarationDataForZoneName:(id)arg1 options:(id)arg2 activity:(id)arg3 error:(id*)arg4;
- (struct NSDictionary { Class x1; }*)__fetchOverridesForRecordIDs:(id)arg1 options:(id)arg2 activity:(id)arg3 error:(id*)arg4;
- (struct NSDictionary { Class x1; }*)__fetchOverridesForZoneName:(id)arg1 options:(id)arg2 activity:(id)arg3 error:(id*)arg4;
...
- (struct NSDictionary { Class x1; }*)_fetchNetworkDeclarationDataForZoneName:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (struct NSDictionary { Class x1; }*)_fetchOverridesForZoneName:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (bool)_removeOverridesForZoneName:(id)arg1 recordName:(id)arg2 options:(id)arg3 error:(id*)arg4;
- (bool)addOverrides:(struct NSDictionary { Class x1; }*)arg1 replace:(bool)arg2 options:(id)arg3 error:(id*)arg4;
- (id)cloudDatabase;
- (id)destroy;
- (struct NSDictionary { Class x1; }*)fetchAllNetworkDeclarationDataWithOptions:(id)arg1 error:(id*)arg2;
- (struct NSDictionary { Class x1; }*)fetchAllOverridesWithOptions:(id)arg1 error:(id*)arg2;
...
- (struct NSDictionary { Class x1; }*)fetchNetworkDeclarationDataForRecordIDs:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (struct NSDictionary { Class x1; }*)fetchNetworkDeclarationDataForZoneName:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (struct NSDictionary { Class x1; }*)fetchOverridesForRecordIDs:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (struct NSDictionary { Class x1; }*)fetchOverridesForZoneName:(id)arg1 options:(id)arg2 error:(id*)arg3;
- (id)flush;
