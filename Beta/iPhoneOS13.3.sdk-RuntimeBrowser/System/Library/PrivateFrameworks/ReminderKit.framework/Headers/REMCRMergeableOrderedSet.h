...
- (id)initWithReplicaIDSource:(id)arg1 document:(struct CRDocument { Class x1; }*)arg2;
- (id)initWithReplicaIDSource:(id)arg1 document:(struct CRDocument { Class x1; }*)arg2 undos:(id)arg3;
