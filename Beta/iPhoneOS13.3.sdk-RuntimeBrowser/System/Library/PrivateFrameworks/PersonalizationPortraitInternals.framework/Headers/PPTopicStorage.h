...
- (void)_prepareDonationStatement:(id)arg1 scoredTopic:(struct PPScoredItem { Class x1; }*)arg2 algorithm:(unsigned long long)arg3 cloudSync:(bool)arg4 decayRate:(double)arg5 sentimentScore:(double)arg6 occurrencesInSource:(unsigned short)arg7 algorithmResultPosition:(unsigned short)arg8 algorithmResultCount:(unsigned short)arg9 weightMultiplier:(double)arg10 sourceRowId:(long long)arg11;
