...
+ (struct PPScoredItem { Class x1; }*)scoreTopics:(id)arg1 scoringDate:(id)arg2 decayRate:(double)arg3 strictFiltering:(bool)arg4 sourceStats:(id)arg5 scoreInterpreter:(id)arg6;
