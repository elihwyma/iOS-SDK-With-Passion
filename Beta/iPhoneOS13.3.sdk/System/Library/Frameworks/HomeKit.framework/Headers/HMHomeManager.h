...
@interface HMHomeManager : NSObject <Swift>
...
@property (nonatomic) _Bool didUpdateHomes;
@property (nonatomic) _Bool frameworkMergeComplete;
...
@property (nonatomic) _Bool mediaAccessoryControlRequested;
...
@property (nonatomic, getter=isViewServiceActive) _Bool viewServiceActive;
@property (readonly) unsigned long long options;
@property (readonly) HMHomeManagerConfiguration *configuration;
@property (copy, nonatomic, readonly) NSArray *incomingHomeInvitations;
@property (nonatomic, readonly) HMHome *currentHome;
@property (weak, readonly) HMAccessory *currentAccessory;
@property (nonatomic, readonly, getter=isDataSyncInProgress) _Bool dataSyncInProgress;
@property (nonatomic, readonly) unsigned long long dataSyncState;
@property (readonly) unsigned long long status;
@property (readonly, getter=isThisDeviceResidentCapable) _Bool thisDeviceResidentCapable;
@property (readonly, getter=isResidentEnabledForThisDevice) _Bool residentEnabledForThisDevice;
@property (readonly, getter=isAccessAllowedWhenLocked) _Bool accessAllowedWhenLocked;
...
@property (copy, nonatomic, readonly) NSArray *homes;
