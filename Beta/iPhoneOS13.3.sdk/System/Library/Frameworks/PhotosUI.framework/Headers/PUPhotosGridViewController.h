...
@property (copy, nonatomic) CDUnknownBlockType onViewDidAppearCompletion;
...
@property (nonatomic, setter=_setNeedsNewEmptyPlaceholderView:) _Bool _needsNewEmptyPlaceholderView;
...
@property (nonatomic) struct UIEdgeInsets collectionViewLayoutReferenceSafeAreaInsets;
...
@property (nonatomic, setter=_setPreviousPrefetchRect:) struct CGRect _previousPrefetchRect;
@property (nonatomic, setter=_setPreviousPreheatContentOffset:) struct CGPoint _previousPreheatContentOffset;
@property (nonatomic, setter=_setPreviousPrefetchContentOffset:) struct CGPoint _previousPrefetchContentOffset;
...
@property (nonatomic, setter=_setMaximumThumbnailRequestSize:) struct CGSize maximumThumbnailRequestSize;
...
@property (copy, nonatomic, setter=ppt_setNextDeleteFinishedBlock:) CDUnknownBlockType ppt_nextDeleteFinishedBlock;
@property (copy, nonatomic, setter=ppt_setDataSourceChangeHandler:) CDUnknownBlockType ppt_dataSourceChangeHandler;
@property (nonatomic, setter=_setDidForceDataSource:) _Bool _didForceDataSource;
...
@property (copy, nonatomic) CDUnknownBlockType pendingProcessDataSourceUpdateBlock;
