...
struct JSWebAssemblyCodeBlockHeapCellType;
...
struct VM {
    ...
    struct unique_ptr<JSC::JSWebAssemblyCodeBlockHeapCellType, std::__1::default_delete<JSC::JSWebAssemblyCodeBlockHeapCellType>> _field15;
    struct unique_ptr<JSC::WebAssemblyFunctionHeapCellType, std::__1::default_delete<JSC::WebAssemblyFunctionHeapCellType>> _field16;
    ...
    struct CompleteSubspace _field24;
    struct CompleteSubspace _field25;
    ...
    struct IsoSubspace _field32;
    struct IsoSubspace _field33;
    ...
    struct unique_ptr<JSC::IsoSubspace, std::__1::default_delete<JSC::IsoSubspace>> _field42;
    struct unique_ptr<JSC::IsoSubspace, std::__1::default_delete<JSC::IsoSubspace>> _field43;
    struct unique_ptr<JSC::IsoSubspace, std::__1::default_delete<JSC::IsoSubspace>> _field44;
    struct unique_ptr<JSC::IsoSubspace, std::__1::default_delete<JSC::IsoSubspace>> _field45;
    struct unique_ptr<JSC::IsoSubspace, std::__1::default_delete<JSC::IsoSubspace>> _field46;
    struct IsoCellSet _field47;
    struct IsoCellSet _field48;
    struct SpaceAndSet _field49;
    struct unique_ptr<JSC::VM::SpaceAndSet, std::__1::default_delete<JSC::VM::SpaceAndSet>> _field50;
    struct unique_ptr<JSC::VM::SpaceAndSet, std::__1::default_delete<JSC::VM::SpaceAndSet>> _field51;
    struct SpaceAndSet _field52;
    struct SpaceAndSet _field53;
    struct SpaceAndSet _field54;
    int _field55;
    struct ClientData *_field56;
    struct EntryFrame *_field57;
    struct ExecState *_field58;
    struct Context _field59;
    ...
    struct Strong<JSC::Structure> _field72;
    ...
    struct Strong<JSC::Structure> _field79[3];
    ...
    struct Strong<JSC::Structure> _field101;
    struct Strong<JSC::Structure> _field102;
    struct Strong<JSC::Structure> _field103;
    struct Strong<JSC::Structure> _field104;
    struct Strong<JSC::Structure> _field105;
    struct Strong<JSC::Structure> _field106;
    struct Strong<JSC::Structure> _field107;
    struct Strong<JSC::JSCell> _field108;
    struct Strong<JSC::JSCell> _field109;
    struct Strong<JSC::JSCell> _field110;
    struct unique_ptr<JSC::PromiseDeferredTimer, std::__1::default_delete<JSC::PromiseDeferredTimer>> _field111;
    struct JSCell *_field112;
    struct ClassInfo *_field113;
    struct AtomStringTable *_field114;
    struct SymbolRegistry _field115;
    struct CommonIdentifiers *_field116;
    struct ArgList *_field117;
    struct SmallStrings _field118;
    struct NumericStrings _field119;
    struct DateInstanceCache _field120;
    struct unique_ptr<WTF::SimpleStats, std::__1::default_delete<WTF::SimpleStats>> _field121;
    struct WeakGCMap<std::__1::pair<JSC::CustomGetterSetter *, int>, JSC::JSCustomGetterSetterFunction, WTF::PairHash<JSC::CustomGetterSetter *, int>, WTF::HashTraits<std::__1::pair<JSC::CustomGetterSetter *, int>>> _field122;
    struct WeakGCMap<WTF::StringImpl *, JSC::JSString, WTF::PtrHash<WTF::StringImpl *>, WTF::HashTraits<WTF::StringImpl *>> _field123;
    struct Strong<JSC::JSString> _field124;
    struct WeakGCMap<WTF::SymbolImpl *, JSC::Symbol, WTF::PtrHash<WTF::SymbolImpl *>, WTF::HashTraits<WTF::SymbolImpl *>> _field125;
    struct StructureCache _field126;
    struct HashMap<WTF::RefPtr<JSC::SourceProvider, WTF::DumbPtrTraits<JSC::SourceProvider>>, WTF::RefPtr<JSC::SourceProviderCache, WTF::DumbPtrTraits<JSC::SourceProviderCache>>, WTF::PtrHash<WTF::RefPtr<JSC::SourceProvider, WTF::DumbPtrTraits<JSC::SourceProvider>>>, WTF::HashTraits<WTF::RefPtr<JSC::SourceProvider, WTF::DumbPtrTraits<JSC::SourceProvider>>>, WTF::HashTraits<WTF::RefPtr<JSC::SourceProviderCache, WTF::DumbPtrTraits<JSC::SourceProviderCache>>>> _field127;
    struct Interpreter *_field128;
    struct unique_ptr<JSC::JITThunks, std::__1::default_delete<JSC::JITThunks>> _field129;
    struct unique_ptr<JSC::FTL::Thunks, std::__1::default_delete<JSC::FTL::Thunks>> _field130;
    struct JSValue _field131;
    unsigned int _field132;
    struct ExecState *_field133;
    struct ExecState *_field134;
    void *_field135;
    struct Instruction *_field136;
    unsigned int _field137;
    void *_field138;
    _Bool _field139;
    struct VMEntryScope *_field140;
    struct JSObject *_field141;
    struct HashSet<JSC::JSObject *, WTF::PtrHash<JSC::JSObject *>, WTF::HashTraits<JSC::JSObject *>> _field142;
    struct LocalTimeOffsetCache _field143;
    struct String _field144;
    double _field145;
    struct unique_ptr<JSC::Profiler::Database, std::__1::default_delete<JSC::Profiler::Database>> _field146;
    struct RefPtr<JSC::TypedArrayController, WTF::DumbPtrTraits<JSC::TypedArrayController>> _field147;
    struct RegExpCache *_field148;
    struct BumpPointerAllocator _field149;
    struct Lock _field150;
    struct unique_ptr<char [], WTF::FastFree<char []>> _field151;
    struct Lock _field152;
    struct Ref<JSC::CompactVariableMap, WTF::DumbPtrTraits<JSC::CompactVariableMap>> _field153;
    struct unique_ptr<JSC::HasOwnPropertyCache, std::__1::default_delete<JSC::HasOwnPropertyCache>> _field154;
    void *_field155;
    unsigned long long _field156;
    void *_field157;
    void *_field158;
    void *_field159;
    struct Exception *_field160;
    struct Exception *_field161;
    _Bool _field162;
    int _field163;
    _Bool _field164;
    _Bool _field165;
    struct unique_ptr<JSC::CodeCache, std::__1::default_delete<JSC::CodeCache>> _field166;
    struct unique_ptr<JSC::BuiltinExecutables, std::__1::default_delete<JSC::BuiltinExecutables>> _field167;
    struct HashMap<WTF::String, WTF::RefPtr<JSC::WatchpointSet, WTF::DumbPtrTraits<JSC::WatchpointSet>>, WTF::StringHash, WTF::HashTraits<WTF::String>, WTF::HashTraits<WTF::RefPtr<JSC::WatchpointSet, WTF::DumbPtrTraits<JSC::WatchpointSet>>>> _field168;
    struct unique_ptr<JSC::TypeProfiler, std::__1::default_delete<JSC::TypeProfiler>> _field169;
    struct unique_ptr<JSC::TypeProfilerLog, std::__1::default_delete<JSC::TypeProfilerLog>> _field170;
    unsigned int _field171;
    _Bool _field172;
    struct Lock _field173;
    struct Vector<JSC::ScratchBuffer *, 0, WTF::CrashOnOverflow, 16> _field174;
    unsigned long long _field175;
    struct InlineWatchpointSet _field176;
    struct FunctionHasExecutedCache _field177;
    struct unique_ptr<JSC::ControlFlowProfiler, std::__1::default_delete<JSC::ControlFlowProfiler>> _field178;
    unsigned int _field179;
    struct Deque<std::__1::unique_ptr<JSC::QueuedTask, std::__1::default_delete<JSC::QueuedTask>>, 0> _field180;
    struct MallocPtr<long long, WTF::FastMalloc> _field181;
    struct VMTraps _field182;
    struct RefPtr<JSC::Watchdog, WTF::DumbPtrTraits<JSC::Watchdog>> _field183;
    struct unique_ptr<JSC::HeapProfiler, std::__1::default_delete<JSC::HeapProfiler>> _field184;
    struct RefPtr<JSC::SamplingProfiler, WTF::DumbPtrTraits<JSC::SamplingProfiler>> _field185;
    struct unique_ptr<JSC::FuzzerAgent, std::__1::default_delete<JSC::FuzzerAgent>> _field186;
    struct unique_ptr<JSC::ShadowChicken, std::__1::default_delete<JSC::ShadowChicken>> _field187;
    struct unique_ptr<JSC::BytecodeIntrinsicRegistry, std::__1::default_delete<JSC::BytecodeIntrinsicRegistry>> _field188;
    struct Function<void (JSC::VM &)> _field189;
...
struct WebAssemblyFunctionHeapCellType;
...
struct unique_ptr<JSC::FTL::Thunks, std::__1::default_delete<JSC::FTL::Thunks>> {
    struct __compressed_pair<JSC::FTL::Thunks *, std::__1::default_delete<JSC::FTL::Thunks>> {
        struct Thunks *_field1;
    } _field1;
};
...
struct unique_ptr<JSC::JSWebAssemblyCodeBlockHeapCellType, std::__1::default_delete<JSC::JSWebAssemblyCodeBlockHeapCellType>> {
    struct __compressed_pair<JSC::JSWebAssemblyCodeBlockHeapCellType *, std::__1::default_delete<JSC::JSWebAssemblyCodeBlockHeapCellType>> {
        struct JSWebAssemblyCodeBlockHeapCellType *_field1;
    } _field1;
};
...
struct unique_ptr<JSC::WebAssemblyFunctionHeapCellType, std::__1::default_delete<JSC::WebAssemblyFunctionHeapCellType>> {
    struct __compressed_pair<JSC::WebAssemblyFunctionHeapCellType *, std::__1::default_delete<JSC::WebAssemblyFunctionHeapCellType>> {
        struct WebAssemblyFunctionHeapCellType *_field1;
    } _field1;
};
