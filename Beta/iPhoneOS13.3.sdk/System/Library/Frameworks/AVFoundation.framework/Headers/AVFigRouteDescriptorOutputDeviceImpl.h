...
- (id)initWithRouteDescriptor:(struct __CFDictionary *)arg1 routeDiscoverer:(struct OpaqueFigRouteDiscoverer *)arg2 volumeController:(struct OpaqueFigVolumeControllerState *)arg3 routingContextFactory:(id)arg4 useRouteConfigUpdatedNotification:(_Bool)arg5;
