...
@property (nonatomic, readonly) struct CGPoint lastInteractionLocation;
@property (nonatomic, readonly) _Bool isEditable;
@property (nonatomic, readonly) _Bool shouldHideSelectionWhenScrolling;
@property (nonatomic, readonly) _Bool shouldIgnoreKeyboardWillHideNotification;
@property (nonatomic, readonly) const struct InteractionInformationAtPosition *positionInformation;
@property (nonatomic, readonly) const struct WKAutoCorrectionData *autocorrectionData;
@property (nonatomic, readonly) const struct FocusedElementInformation *focusedElementInformation;
...
@property (nonatomic, readonly) _Bool preventsPanningInXAxis;
@property (nonatomic, readonly) _Bool preventsPanningInYAxis;
...
@property (nonatomic, readonly) struct InteractionInformationAtPosition currentPositionInformation;
@property (nonatomic, readonly) _Bool _shouldUseContextMenus;
@property (nonatomic, readonly) _Bool _shouldAvoidResizingWhenInputViewBoundsChange;
@property (nonatomic, readonly) _Bool _shouldAvoidScrollingWhenFocusedContentIsVisible;
@property (nonatomic, readonly) _Bool _shouldUseLegacySelectPopoverDismissalBehavior;
@property (readonly) unsigned long long hash;
@property (readonly) Class superclass;
@property (copy, readonly) NSString *description;
@property (copy, readonly) NSString *debugDescription;
...
@property (nonatomic, readonly) struct WebPageProxy *page;
@property (nonatomic, readonly) _Bool isFocusingElement;
@property (nonatomic, getter=isShowingInspectorIndication) _Bool showingInspectorIndication;
@property (nonatomic, readonly, getter=isResigningFirstResponder) _Bool resigningFirstResponder;
