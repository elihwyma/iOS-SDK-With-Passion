...
@property (nonatomic, getter=hasLimitedInteraction) _Bool limitInteraction;
@property (nonatomic, getter=allowsTransitLineSelection) _Bool allowTransitLineSelection;
