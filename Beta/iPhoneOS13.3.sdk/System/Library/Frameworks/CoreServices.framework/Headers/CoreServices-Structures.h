...
struct vector<LSBinding, std::__1::allocator<LSBinding>> {
    struct LSBinding *_field1;
    struct LSBinding *_field2;
    struct __compressed_pair<LSBinding *, std::__1::allocator<LSBinding>> {
        struct LSBinding *_field1;
    } _field3;
};
...
typedef struct vector<LSBinding, std::__1::allocator<LSBinding>> {
    struct LSBinding *_field1;
    struct LSBinding *_field2;
    struct __compressed_pair<LSBinding *, std::__1::allocator<LSBinding>> {
        struct LSBinding *_field1;
