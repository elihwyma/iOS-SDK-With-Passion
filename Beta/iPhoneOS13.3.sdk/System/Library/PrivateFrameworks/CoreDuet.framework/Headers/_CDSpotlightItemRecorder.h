...
@interface _CDSpotlightItemRecorder : NSObject
...
@property (retain, nonatomic) id <_CDInteractionRecording><_CDInteractionDeleting> recorder;
@property (nonatomic, readonly) _Bool canRecordInteractions;
