...
@interface HDHealthServicesServer : HDSubserver
...
@property (retain, nonatomic) HDHealthServiceManager *healthServiceManager;
...
@property (retain, nonatomic) NSUUID *subserverUUID;
@property (retain, nonatomic) id <HKHealthStoreClientInterface> clientRemoteObjectProxy;
