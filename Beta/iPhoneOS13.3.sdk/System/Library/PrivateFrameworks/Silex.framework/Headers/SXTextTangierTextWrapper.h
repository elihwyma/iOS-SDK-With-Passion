...
@interface SXTextTangierTextWrapper : NSObject
...
@property (nonatomic) struct CGAffineTransform canvasSpaceToWrapSpace;
@property (nonatomic) struct CGAffineTransform wrapSpaceToCanvasSpace;
