...
@property (nonatomic, readonly) struct photoIrisStillDisplayTime;
@property (nonatomic, readonly) struct photoIrisVideoDuration;
@property (nonatomic, readonly) _Bool hasPhotoColorAdjustments;
@property (nonatomic, readonly) unsigned long long deferredLogInfo;
@property (nonatomic, readonly) struct videoKeyFrameSourceTime;
