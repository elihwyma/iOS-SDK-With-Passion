...
- (id)_analyzeOndemand:(id)arg1 forAnalysisTypes:(unsigned long long)arg2 withExistingAnalysis:(id)arg3 storeAnalysis:(_Bool)arg4;
- (id)_databaseForPhotoLibrary:(id)arg1;
- (id)requestAnalysisForAsset:(id)arg1 withExistingAnalysis:(id)arg2 andDatabase:(id)arg3 analysisTypes:(unsigned long long)arg4 allowOndemand:(_Bool)arg5;
...
- (int)requestAnalysisTypes:(unsigned long long)arg1 forAssets:(id)arg2 allowOndemand:(_Bool)arg3 progressHandler:(CDUnknownBlockType)arg4 analyses:(id)arg5;
