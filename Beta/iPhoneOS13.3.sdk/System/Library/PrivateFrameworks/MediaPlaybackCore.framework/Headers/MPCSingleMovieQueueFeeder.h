...
@interface MPCSingleMovieQueueFeeder : MPQueueFeeder
...
@property (retain, nonatomic) MPMovie *movie;
@property (retain, nonatomic) NSString *movieIdentifier;
@property (nonatomic, readonly) id <MPMutableIdentifierListSection> section;
