...
@property (nonatomic, readonly) vector_9706d78e *viewports;
@property (nonatomic, readonly) vector_dc8a7a87 *scissorRects;
@property (nonatomic, readonly) CDStruct_8727d297 viewport;
...
@property (nonatomic, readonly) CDStruct_0f4bf8df tessellationFactorBufferArgument;
