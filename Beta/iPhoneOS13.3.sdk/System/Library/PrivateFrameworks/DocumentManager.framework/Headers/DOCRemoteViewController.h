...
+ (struct _UIResilientRemoteViewContainerViewController { Class x1; }*)instantiateRemoteViewControllerWithConfiguration:(id)arg1 transparent:(bool)arg2 errorHandler:(id /* block */)arg3 hostProxy:(id)arg4 completionHandler:(id /* block */)arg5;
+ (id)serviceExtension;
