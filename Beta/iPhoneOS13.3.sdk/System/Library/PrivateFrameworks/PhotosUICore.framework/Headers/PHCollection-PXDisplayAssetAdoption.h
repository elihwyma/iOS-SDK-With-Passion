...
@interface PHCollection (PXDisplayAssetAdoption) <Swift>
...
@property (nonatomic, readonly) _Bool px_allowsAssetsDrop;
@property (nonatomic, readonly) _Bool px_allowsSpringLoading;
@property (nonatomic, readonly) _Bool px_allowsImplicitSelectionForProjectOrSharingAction;
