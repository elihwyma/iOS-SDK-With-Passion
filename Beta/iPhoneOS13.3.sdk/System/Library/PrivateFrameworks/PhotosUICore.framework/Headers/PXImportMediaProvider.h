...
+ (void)registerPXImportMediaProviderNotificationsReceiver:(struct NSObject { Class x1; }*)arg1;
+ (void)unregisterPXImportMediaProviderNotificationsReceiver:(struct NSObject { Class x1; }*)arg1;
