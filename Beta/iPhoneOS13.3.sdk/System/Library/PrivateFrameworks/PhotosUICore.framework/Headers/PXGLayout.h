...
@interface PXGLayout : NSObject <PXGDataSourceDrivenLayout, PXGDiagnosticsProvider, PXGSpriteIndexReferencing> {
...
- (void)didFaultInSublayout:(id)arg1 fromEstimatedContentSize:(struct CGSize { double x1; double x2; })arg2;
