...
@property (nonatomic) struct os_unfair_lock_s containedObjectsLock;
@property (nonatomic) struct os_unfair_lock_s storeMetadataLock;
@property (nonatomic) struct os_unfair_lock_s lightweightMigrationLock;
