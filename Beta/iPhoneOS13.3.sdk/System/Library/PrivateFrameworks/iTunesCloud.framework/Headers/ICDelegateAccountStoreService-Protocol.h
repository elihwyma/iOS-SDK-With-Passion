...
@protocol ICDelegateAccountStoreService <Swift>

- (unsigned short)openWithCompletionHandler: /* Error: Ran out of types for this method. */;
- (unsigned short)recreateWithCompletionHandler: /* Error: Ran out of types for this method. */;
