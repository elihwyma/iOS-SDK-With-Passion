...
@interface RMSIDSServer : NSObject
...
- (void)controlSession:(id)arg1 didReceivePairingChallengeRequestWithCredentials:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
