...
- (bool)isSuspended;
- (id)operationQueue;
- (struct UIImage { Class x1; }*)previewImageForNote:(id)arg1 minSize:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3 appearanceInfo:(id)arg4;
...
- (struct UIImage { Class x1; }*)renderPreviewImageForNote:(id)arg1 minSize:(struct CGSize { double x1; double x2; })arg2 scale:(double)arg3 appearanceInfo:(id)arg4 cache:(id)arg5 cacheKey:(id)arg6;
