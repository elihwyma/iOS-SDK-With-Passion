...
@class BWStillImageCaptureSettings, FigCaptureStillImageSettings, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString;
...
- (unsigned long long)_getUUIDBytes:(id)arg1 high:(_Bool)arg2;
...
- (_Bool)_archiveObjectWithPath:(id)arg1 object:(id)arg2 error:(id *)arg3;
- (id)_unarchiveObjectWithPath:(id)arg1 classes:(id)arg2 error:(id *)arg3;
- (_Bool)valid:(int *)arg1;
