...
@interface WFRunnableLibraryResultsController : WFDatabaseCollectionViewResultsController <Swift>
...
@property (weak, nonatomic) id <WFRunnableLibraryResultsControllerDelegate> delegate;
@property (weak, nonatomic) id <WFBaseLibraryWorkflowCellDelegate> cellDelegate;
@property (copy, nonatomic) id <WFBaseLibraryWorkflowCellMetrics> cellLayoutMetrics;
