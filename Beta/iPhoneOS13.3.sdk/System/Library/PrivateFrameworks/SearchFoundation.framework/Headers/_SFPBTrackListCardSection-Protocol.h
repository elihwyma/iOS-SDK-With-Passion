...
@protocol _SFPBTrackListCardSection <Swift>
...
- (unsigned short)addTracks: /* Error: Ran out of types for this method. */;
- (unsigned short)clearTracks;
- (unsigned short)tracksCount;
- (unsigned short)tracksAtIndex: /* Error: Ran out of types for this method. */;
