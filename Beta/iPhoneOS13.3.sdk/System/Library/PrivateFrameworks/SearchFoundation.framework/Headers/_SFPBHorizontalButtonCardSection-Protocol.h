...
@protocol _SFPBHorizontalButtonCardSection <Swift>
...
- (unsigned short)addButtonCardSections: /* Error: Ran out of types for this method. */;
- (unsigned short)clearButtonCardSections;
- (unsigned short)buttonCardSectionsCount;
- (unsigned short)buttonCardSectionsAtIndex: /* Error: Ran out of types for this method. */;
