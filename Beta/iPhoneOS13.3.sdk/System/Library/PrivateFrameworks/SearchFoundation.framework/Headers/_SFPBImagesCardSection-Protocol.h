...
@protocol _SFPBImagesCardSection <Swift>
...
- (unsigned short)clearImages;
- (unsigned short)addImages: /* Error: Ran out of types for this method. */;
- (unsigned short)imagesCount;
- (unsigned short)imagesAtIndex: /* Error: Ran out of types for this method. */;
