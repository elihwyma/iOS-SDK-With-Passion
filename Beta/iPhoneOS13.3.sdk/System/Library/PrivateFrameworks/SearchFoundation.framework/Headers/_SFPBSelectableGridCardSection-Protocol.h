...
@protocol _SFPBSelectableGridCardSection <Swift>
...
- (unsigned short)clearEntries;
- (unsigned short)entriesAtIndex: /* Error: Ran out of types for this method. */;
- (unsigned short)addEntries: /* Error: Ran out of types for this method. */;
