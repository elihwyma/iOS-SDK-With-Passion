...
@protocol _SFPBNowPlayingCardSection <Swift>
...
- (unsigned short)addMovies: /* Error: Ran out of types for this method. */;
- (unsigned short)clearMovies;
- (unsigned short)moviesCount;
- (unsigned short)moviesAtIndex: /* Error: Ran out of types for this method. */;
