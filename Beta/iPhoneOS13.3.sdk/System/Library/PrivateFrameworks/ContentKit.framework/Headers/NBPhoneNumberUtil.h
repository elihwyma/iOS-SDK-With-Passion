...
@property (retain, nonatomic) NSMutableDictionary *i18nNumberFormat;
@property (retain, nonatomic) NSMutableDictionary *i18nPhoneNumberDesc;
@property (retain, nonatomic) NSMutableDictionary *i18nPhoneMetadata;
@property (retain, nonatomic) NSRegularExpression *PLUS_CHARS_PATTERN;
