...
- (id)initWithSize:(struct CGSize { double x1; double x2; })arg1 scale:(struct SCNVector3 { float x1; float x2; float x3; })arg2 position:(struct SCNVector3 { float x1; float x2; float x3; })arg3 renderLast:(bool)arg4 orientToCamera:(bool)arg5 rotation:(struct SCNVector3 { float x1; float x2; float x3; })arg6 palettesDescriptions:(id)arg7 shaderModifiers:(id)arg8;
- (id)node;
- (id)nodeName;
- (bool)orientToCamera;
