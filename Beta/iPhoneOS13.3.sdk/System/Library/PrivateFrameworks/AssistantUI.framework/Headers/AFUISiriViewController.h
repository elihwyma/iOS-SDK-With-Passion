...
@interface AFUISiriViewController : UIViewController <Swift>
...
@property (nonatomic, readonly, getter=_session) AFUISiriSession *session;
@property (nonatomic, readonly, getter=_remoteViewController) AFUISiriRemoteSceneViewController *remoteViewController;
@property (nonatomic, readonly, getter=_remoteViewControllerDispatchQueue) NSObject<OS_dispatch_queue> *remoteViewControllerDispatchQueue;
@property (nonatomic, getter=_hasCalledBeginAppearanceTransition, setter=_setHasCalledBeginAppearanceTransition:) _Bool hasCalledBeginAppearanceTransition;
@property (nonatomic, getter=_hasCalledEndAppearanceTransition, setter=_setHasCalledEndAppearanceTransition:) _Bool hasCalledEndAppearanceTransition;
...
@property (nonatomic, getter=_isInHoldToTalkMode, setter=_setInHoldToTalkMode:) _Bool inHoldToTalkMode;
...
@property (nonatomic, getter=_isUserUtteranceTapToEditInProgress, setter=_setUserUtteranceTapToEditInProgress:) _Bool userUtteranceTapToEditInProgress;
@property (retain, nonatomic) UIView *inputAccessoryView;
@property (nonatomic, getter=_isPunchingOut, setter=_setPunchingOut:) _Bool punchingOut;
...
@property (nonatomic, getter=isDeviceInStarkMode, setter=setDeviceInStarkMode:) _Bool deviceIsInStarkMode;
