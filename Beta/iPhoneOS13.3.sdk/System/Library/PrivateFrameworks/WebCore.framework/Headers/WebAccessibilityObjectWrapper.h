...
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityArticleAncestor;
- (struct CGPoint { double x1; double x2; })_accessibilityConvertPointToViewSpace:(struct CGPoint { double x1; double x2; })arg1;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityFieldsetAncestor;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityFrameAncestor;
- (bool)_accessibilityHasTouchEventListener;
- (bool)_accessibilityIsInTableCell;
- (bool)_accessibilityIsLandmarkRole:(int)arg1;
- (bool)_accessibilityIsStrongPasswordField;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityLandmarkAncestor;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityListAncestor;
...
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityTableAncestor;
- (unsigned long long)_accessibilityTextEntryTraits;
- (unsigned long long)_accessibilityTraitsFromAncestors;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)_accessibilityTreeAncestor;
...
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)accessibilityObjectForTextMarker:(id)arg1;
- (id)accessibilityPlaceholderValue;
- (id)accessibilityPlatformMathSubscriptKey;
- (id)accessibilityPlatformMathSuperscriptKey;
- (id)accessibilityPopupValue;
- (struct WebAccessibilityObjectWrapper { Class x1; struct AccessibilityObject {} *x2; unsigned int x3; int x4; unsigned long long x5; }*)accessibilityPostProcessHitTest:(struct CGPoint { double x1; double x2; })arg1;
...
- (struct AccessibilityTableCell { int (**x1)(); unsigned int x2; unsigned int x3; struct Vector<WTF::RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> >, 0, WTF::CrashOnOverflow, 16> { struct RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> > {} *x_4_1_1; unsigned int x_4_1_2; unsigned int x_4_1_3; } x4; bool x5; int x6; int x7; struct AccessibilityIsIgnoredFromParentData { struct AccessibilityObject {} *x_8_1_1; bool x_8_1_2; bool x_8_1_3; bool x_8_1_4; } x8; bool x9; bool x10; struct RetainPtr<WebAccessibilityObjectWrapper> { void *x_11_1_1; } x11; int x12; int x13; struct Node {} *x14; struct WeakPtrFactory<WebCore::AccessibilityRenderObject> { struct RefPtr<WTF::WeakPtrImpl, WTF::DumbPtrTraits<WTF::WeakPtrImpl> > { struct WeakPtrImpl {} *x_1_2_1; } x_15_1_1; } x15; struct WeakPtr<WebCore::RenderObject> { struct RefPtr<WTF::WeakPtrImpl, WTF::DumbPtrTraits<WTF::WeakPtrImpl> > { struct WeakPtrImpl {} *x_1_2_1; } x_16_1_1; } x16; int x17; int x18; }*)tableCellParent;
- (struct AccessibilityTable { int (**x1)(); unsigned int x2; unsigned int x3; struct Vector<WTF::RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> >, 0, WTF::CrashOnOverflow, 16> { struct RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> > {} *x_4_1_1; unsigned int x_4_1_2; unsigned int x_4_1_3; } x4; bool x5; int x6; int x7; struct AccessibilityIsIgnoredFromParentData { struct AccessibilityObject {} *x_8_1_1; bool x_8_1_2; bool x_8_1_3; bool x_8_1_4; } x8; bool x9; bool x10; struct RetainPtr<WebAccessibilityObjectWrapper> { void *x_11_1_1; } x11; int x12; int x13; struct Node {} *x14; struct WeakPtrFactory<WebCore::AccessibilityRenderObject> { struct RefPtr<WTF::WeakPtrImpl, WTF::DumbPtrTraits<WTF::WeakPtrImpl> > { struct WeakPtrImpl {} *x_1_2_1; } x_15_1_1; } x15; struct WeakPtr<WebCore::RenderObject> { struct RefPtr<WTF::WeakPtrImpl, WTF::DumbPtrTraits<WTF::WeakPtrImpl> > { struct WeakPtrImpl {} *x_1_2_1; } x_16_1_1; } x16; struct Vector<WTF::RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> >, 0, WTF::CrashOnOverflow, 16> { struct RefPtr<WebCore::AccessibilityObject, WTF::DumbPtrTraits<WebCore::AccessibilityObject> > {} *x_17_1_1; unsigned int x_17_1_2; unsigned int x_17_1_3; } x17; }*)tableParent;
