...
- (_Bool)runCPUPathOnInput:(struct HGBitmap *)arg1 guide:(struct HGBitmap *)arg2 output:(struct HGBitmap *)arg3 radius:(int)arg4 epsilon:(float)arg5;
...
- (_Bool)applyFilterToInput:(id)arg1 output:(id)arg2;
