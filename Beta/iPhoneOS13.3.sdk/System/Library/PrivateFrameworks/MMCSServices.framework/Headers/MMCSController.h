...
- (void)_handleRegistrationForMMCSPutFile:(id)arg1 preauthenticate:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)_registerTransfers:(id)arg1 preauthenticate:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
- (void)_registerFiles:(id)arg1 preauthenticate:(_Bool)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (_Bool)_putTransfers:(id)arg1 requestURL:(id)arg2 requestorID:(id)arg3 transferID:(id)arg4 token:(id)arg5 error:(id *)arg6;
