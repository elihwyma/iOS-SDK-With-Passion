...
@interface HUEditRoomViewController : HUItemTableViewController
...
@property (weak, nonatomic, readonly) id <HUEditRoomViewControllerPresentationDelegate> presentationDelegate;
@property (weak, nonatomic, readonly) id <HUEditRoomViewControllerAddRoomDelegate> addRoomDelegate;
