...
+ (id)__jsonFromDeclarations:(struct NSDictionary { Class x1; }*)arg1 rawOutput:(bool)arg2 error:(id*)arg3;
+ (id)__jsonFromRecords:(id)arg1 rawOutput:(bool)arg2 error:(id*)arg3;
+ (id)__jsonStringFromDictionary:(struct NSDictionary { Class x1; }*)arg1 rawOutput:(bool)arg2 error:(id*)arg3;
...
- (struct NSDictionary { Class x1; }*)_fetchAllNetworkDeclarationDataForProductGroup:(id)arg1 productNumber:(id)arg2 options:(id)arg3 error:(id*)arg4;
- (struct NSDictionary { Class x1; }*)_fetchAllOverridesForProductGroup:(id)arg1 productNumber:(id)arg2 options:(id)arg3 error:(id*)arg4;
