...
@interface WLMessagesMigrator : NSObject
...
- (id)importWillBegin;
- (void)importDidEnd;
- (_Bool)_insertMessage:(id)arg1;
- (id)_databaseFilename;
- (_Bool)_performSimpleQuery:(id)arg1;
...
- (_Bool)_insertMessageAttachmentJoinRowWithMessageID:(long long)arg1 attachmentID:(long long)arg2;
- (long long)_chatIDForHandleIDs:(id)arg1 groupRoomName:(id)arg2 groupID:(id)arg3 message:(id)arg4;
- (_Bool)_insertChatMessageJoinRowWithChatID:(long long)arg1 messageID:(long long)arg2;
- (_Bool)_commitTransaction;
- (_Bool)_rollbackTransaction;
- (long long)_messageDateWithMessage:(id)arg1;
- (_Bool)_messageIsFromMeWithMessage:(id)arg1;
...
- (_Bool)_insertChatHandleJoinRowWithChatID:(long long)arg1 handleID:(long long)arg2 duplicateMightExist:(_Bool)arg3;
