...
@property (weak, nonatomic, readonly) id <EDSearchableIndexHookResponder> hookResponder;
@property (nonatomic) struct os_unfair_lock_s lastProcessedAttachmentIDLock;
