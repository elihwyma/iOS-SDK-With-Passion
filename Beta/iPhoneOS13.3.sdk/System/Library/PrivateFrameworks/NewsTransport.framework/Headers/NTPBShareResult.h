...
@interface NTPBShareResult : PBCodable
...
@property (nonatomic, readonly) _Bool hasIosActivityType;
...
@property (nonatomic, readonly) _Bool hasExternalWeblinkUrl;
...
@property (nonatomic) _Bool isSearchResult;
