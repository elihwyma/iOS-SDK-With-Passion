...
@property (nonatomic) struct CHNeuralNetwork *engine;
@property (nonatomic) struct CHNeuralNetwork *freeformEngine;
...
@property (nonatomic) struct Network *radicalClusterFST;
@property (nonatomic) struct Network *formatGrammarFST;
...
@property (nonatomic) _Bool saveDrawingUntilNextCandidateAccepted;
@property (copy, nonatomic) CHDrawing *cachedDrawing;
@property (nonatomic) map_107962fc cachedResults;
@property (nonatomic) map_c92806bd characterIDMap;
@property (nonatomic) struct VariantMap *transliterationVariantMap;
