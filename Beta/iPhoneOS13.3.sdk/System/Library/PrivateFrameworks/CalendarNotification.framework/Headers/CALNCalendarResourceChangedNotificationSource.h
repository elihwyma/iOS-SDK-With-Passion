...
@interface CALNCalendarResourceChangedNotificationSource : NSObject
...
@property (nonatomic, readonly) id <CALNCalendarResourceChangedNotificationDataSource> dataSource;
