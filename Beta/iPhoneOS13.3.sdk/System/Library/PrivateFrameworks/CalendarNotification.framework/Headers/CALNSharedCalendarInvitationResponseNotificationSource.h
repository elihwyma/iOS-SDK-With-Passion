...
@interface CALNSharedCalendarInvitationResponseNotificationSource : NSObject
...
@property (nonatomic, readonly) id <CALNSharedCalendarInvitationResponseNotificationDataSource> dataSource;
