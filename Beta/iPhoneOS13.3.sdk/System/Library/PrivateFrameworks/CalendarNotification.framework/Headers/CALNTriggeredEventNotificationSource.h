...
@interface CALNTriggeredEventNotificationSource : NSObject
...
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationDataSource> dataSource;
...
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationTriggerHelper> triggerHelper;
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationTransitionProvider> transitionProvider;
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationBodyDescriptionProvider> bodyDescriptionProvider;
@property (nonatomic, readonly) id <CALNTravelAdvisoryTimelinessAuthority> travelAdvisoryTimelinessAuthority;
@property (nonatomic, readonly) id <CalDateProvider> dateProvider;
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationDataStorage> notificationDataStorage;
@property (nonatomic, readonly) id <CALNTimeToLeaveRefreshStorage> timeToLeaveRefreshStorage;
@property (nonatomic, readonly) NSMutableDictionary *eventURLToObjectIDMap;
@property (nonatomic, readonly) id <CALNURLHandler> urlHandler;
@property (nonatomic, readonly) id <CALNTriggeredEventNotificationMapItemURLProvider> mapItemURLProvider;
