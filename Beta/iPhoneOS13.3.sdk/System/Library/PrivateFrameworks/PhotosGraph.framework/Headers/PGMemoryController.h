...
@property (copy, readonly) CDUnknownBlockType progressBlock;
@property (readonly) _Bool isCreatingEverMemories;
@property _Bool bypassesCategoryCheckForUpgrades;
@property (retain) NSSet *blacklistedFeatures;
@property (retain) NSSet *categoryWhitelist;
@property (retain) NSSet *categoryBlacklist;
@property _Bool ignoresMomentIsInteresting;
@property _Bool ignoresMinimumNumberOfMoments;
@property _Bool ignoresMinimumNumberOfAssets;
@property _Bool skipsAssetCollection;
@property _Bool skipsCuration;
@property _Bool skipsTitleGeneration;
@property _Bool skipsWeekendUpgrades;
@property _Bool skipsMeaningfulEventUpgrades;
@property _Bool skipsBestOfPastUpgradeToFeaturedTrip;
@property _Bool skipsBlacklistedFeatureCheck;
...
@property _Bool probabilityAlwaysPasses;
@property (weak, nonatomic, readonly) PGManager *manager;
