...
@property (nonatomic, readonly) _Bool isSetupComplete;
@property (nonatomic, readonly) _Bool hasPostedSetupComplete;
...
@property (nonatomic, readonly) _Bool shouldHoldChatMessages;
@property (nonatomic, readonly) _Bool isHoldingChatMessages;
