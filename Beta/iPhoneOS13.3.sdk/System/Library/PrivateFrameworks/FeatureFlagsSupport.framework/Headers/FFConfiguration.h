...
- (struct NSMutableDictionary { Class x1; }*)makeFeatureDictionaryFrom:(id)arg1 forDomain:(id)arg2;
- (void)populateDictionary:(id)arg1 withFeatures:(struct NSMutableDictionary { Class x1; }*)arg2;
