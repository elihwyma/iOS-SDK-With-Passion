...
- (void).cxx_destruct;
- (struct CGSize { double x1; double x2; })_computeContentSizeForEmptyHostContentSizeForContainer:(id)arg1 hostContentSize:(struct CGSize { double x1; double x2; })arg2 layoutAxis:(int)arg3 supplementaryFrames:(id)arg4 preferredSizes:(id)arg5 layoutRTL:(bool)arg6 supplementaryKind:(long long)arg7;
...
- (struct CGSize { double x1; double x2; })_largestPossibleHostContentSizeForContainerSize:(struct CGSize { double x1; double x2; })arg1 layoutAxis:(int)arg2;
...
- (struct CGSize { double x1; double x2; })_requiredContentSizeForSupplementaryFrames:(id)arg1 forLayoutAxis:(int)arg2 containerSize:(struct CGSize { double x1; double x2; })arg3;
