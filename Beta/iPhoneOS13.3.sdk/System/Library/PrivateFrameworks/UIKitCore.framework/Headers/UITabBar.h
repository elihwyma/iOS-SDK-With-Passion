...
@property (nonatomic, setter=_setScrollsItems:) _Bool _scrollsItems;
...
@property (nonatomic, readonly, getter=_focusedTabBarItem) UITabBarItem *focusedTabBarItem;
@property (nonatomic, readonly, getter=_focusedIndex) long long focusedIndex;
@property (nonatomic, readonly, getter=_useVibrantItems) _Bool useVibrantItems;
...
@property (nonatomic, readonly, getter=isCustomizing) _Bool customizing;
