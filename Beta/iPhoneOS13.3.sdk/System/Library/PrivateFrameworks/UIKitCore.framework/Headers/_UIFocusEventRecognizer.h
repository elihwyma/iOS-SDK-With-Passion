...
@interface _UIFocusEventRecognizer : NSObject <Swift>
...
@property (nonatomic, readonly, getter=_motionEffectsController) _UIFocusMotionEffectsController *motionEffectsController;
...
@property (nonatomic) _Bool supportsFastScrolling;
