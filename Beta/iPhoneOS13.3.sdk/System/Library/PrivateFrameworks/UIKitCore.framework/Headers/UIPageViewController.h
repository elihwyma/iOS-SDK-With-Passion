...
@interface UIPageViewController : UIViewController <Swift>
...
@property (nonatomic, readonly, getter=_isPageControlVisible) _Bool _pageControlVisible;
...
@property (nonatomic, readonly, getter=_isInterfaceRotating) _Bool _interfaceRotating;
