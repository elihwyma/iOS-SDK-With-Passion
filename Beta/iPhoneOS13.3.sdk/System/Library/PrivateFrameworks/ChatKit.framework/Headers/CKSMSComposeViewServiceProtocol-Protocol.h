...
@protocol CKSMSComposeViewServiceProtocol <Swift>
...
- (unsigned short)insertRemoteItemForSending: /* Error: Ran out of types for this method. */;
- (unsigned short)insertRemoteItemForSendingAndCalculateEntryViewFrame:completion: /* Error: Ran out of types for this method. */;
- (unsigned short)insertFilename:MIMEType:exportedFilename:options: /* Error: Ran out of types for this method. */;
- (unsigned short)showInsertedItemInEntryView;
