...
@property (nonatomic, readonly) struct CGAffineTransform transformToWP;
...
@property (nonatomic, readonly) struct CGRect frameBounds;
@property (nonatomic, readonly) struct CGRect typographicBounds;
@property (nonatomic, readonly) struct CGRect typographicBoundsForCell;
