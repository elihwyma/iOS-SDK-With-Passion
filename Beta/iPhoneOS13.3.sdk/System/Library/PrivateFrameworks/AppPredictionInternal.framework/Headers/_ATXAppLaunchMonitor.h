...
@class NSUserDefaults, PETScalarEventTracker, _PASLock, _PASQueueLock;
...
+ (void)mergeAppLaunches:(id)arg1 andBacklightTransitions:(id)arg2 callingAppLaunchBlock:(CDUnknownBlockType)arg3;
...
- (void)updateLaunchHistoryFromDuet:(double)arg1 callback:(CDUnknownBlockType)arg2;
...
- (void)_addLaunchWithLockWitness:(id)arg1 bundleId:(id)arg2 date:(id)arg3 timeZone:(id)arg4 reason:(id)arg5 isExtension:(_Bool)arg6;
