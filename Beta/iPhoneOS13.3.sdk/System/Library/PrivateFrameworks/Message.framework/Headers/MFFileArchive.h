...
@property (nonatomic) struct _NSRange inputRange;
@property (retain, nonatomic) NSMutableData *outputData;
@property (copy, nonatomic) CDUnknownBlockType readerBlock;
@property (copy, nonatomic) CDUnknownBlockType writerBlock;
